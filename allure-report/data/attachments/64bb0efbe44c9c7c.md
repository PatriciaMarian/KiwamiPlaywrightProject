...
- generic [ref=f8e1]:
  ...
  - generic [ref=f8e40]:
      ...
      - generic [ref=f8e43]:
        - generic [ref=f8e44]:
          ...
          - generic [ref=f8e47]:
            ...
            - text: Mr.
          - generic [ref=f8e51]:
            - radio "Mrs." [checked] [ref=f8e53]
            - text: Mrs.
        - generic [ref=f8e54]:
          - generic [ref=f8e55]:
            - text: Name
            - superscript [ref=f8e56]: "*"
          - textbox "Name *" [ref=f8e57]: Marcella
        - generic [ref=f8e58]:
          - generic [ref=f8e59]:
            - text: Email
            - superscript [ref=f8e60]: "*"
          - textbox "Email *" [disabled] [ref=f8e61]: Fatima66@yahoo.com
        - generic [ref=f8e62]:
          - generic [ref=f8e63]:
            - text: Password
            - superscript [ref=f8e64]: "*"
          - textbox "Password *" [ref=f8e65]: DFR4CztOheRztJ9
        - generic [ref=f8e66]:
          ...
          - generic [ref=f8e68]:
            ...
            - combobox [ref=f8e77]:
              ...
              - option "1900"
        - generic [ref=f8e78]:
          - checkbox "Sign up for our newsletter!" [checked] [ref=f8e79]
          - text: Sign up for our newsletter!
        - generic [ref=f8e80]:
          - checkbox "Receive special offers from our partners!" [checked] [ref=f8e81]
        ...
        - paragraph [ref=f8e83]:
          ...
          - textbox "First name *" [ref=f8e86]: Marcella
        - paragraph [ref=f8e87]:
          - generic [ref=f8e88]:
            - text: Last name
            - superscript [ref=f8e89]: "*"
          - textbox "Last name *" [ref=f8e90]: Cremin
        - paragraph [ref=f8e91]:
          - generic [ref=f8e92]: Company
          - textbox "Company" [ref=f8e93]: Koepp - Boyle
        - paragraph [ref=f8e94]:
          - generic [ref=f8e95]:
            - text: Address
            - superscript [ref=f8e96]: "*"
            - text: (Street address, P.O. Box, Company name, etc.)
          - textbox "Address * (Street address, P.O. Box, Company name, etc.)" [active] [ref=f8e97]: 19848 Barn Close
        - paragraph [ref=f8e98]:
    ...
    - insertion [ref=f8e123]:
      - generic [ref=f8e126]:
        ...
        - link "Automation testing courses" [ref=f8e129] [cursor=pointer]
        - link "Download Tech Manuals" [ref=f8e134] [cursor=pointer]
        - link "Explore Streaming Services" [ref=f8e139] [cursor=pointer]
  ...
  - link "" [ref=f8e160] [cursor=pointer]:
    - /url: "#top"
  - insertion [ref=f8e163]:
    - generic [ref=f8e166]:
      - heading "These are topics related to the article that might interest you" [level=2] [ref=f8e168]: Discover more
      - link "Software testing resources" [ref=f8e169] [cursor=pointer]
      - link "Compare Smart TVs" [ref=f8e174] [cursor=pointer]
      - link "Automation consulting services" [ref=f8e179] [cursor=pointer]
```
