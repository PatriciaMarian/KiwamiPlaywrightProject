...
Call log:
  - waiting for locator('#email')
    - locator resolved to <input id="email" type="text" required="" name="email" wfd-id="id4" data-qa="email" disabled="disabled" class="form-control" value="Soledad.Daniel28@gmail.com"/>
    - fill("Soledad.Daniel28@gmail.com")
...
- generic [ref=f11e1]:
  ...
  - generic [ref=f11e40]:
    - generic [ref=f11e41]:
      ...
      - generic [ref=f11e43]:
        ...
        - generic [ref=f11e54]:
          ...
          - textbox "Name *" [active] [ref=f11e57]: Amaya
        - generic [ref=f11e58]:
          - generic [ref=f11e59]:
            - text: Email
            - superscript [ref=f11e60]: "*"
          - textbox "Email *" [disabled] [ref=f11e61]: Soledad.Daniel28@gmail.com
        - generic [ref=f11e62]:
          - generic [ref=f11e63]:
            - text: Password
    ...
    - insertion [ref=f11e123]:
      - generic [ref=f11e126]:
        ...
        - link "Computer Security" [ref=f11e129] [cursor=pointer]
        - link "Automation software solutions" [ref=f11e134] [cursor=pointer]
        - link "Software testing services" [ref=f11e139] [cursor=pointer]
  ...
  - insertion [ref=f11e161]:
    - generic [ref=f11e164]:
      ...
      - link "API testing tools" [ref=f11e167] [cursor=pointer]
      - link "Programming" [ref=f11e172] [cursor=pointer]
      - link "Software testing resources" [ref=f11e177] [cursor=pointer]
```
...
```ts
  ...
  41  |         this.accountemail = page.locator('#email');
  42  | 
